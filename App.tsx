  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
        ...
        {/* Changed mx-auto to ml-auto and added right margins to align content to the right */}
        {/* Added bg-white, p-6, rounded-lg, shadow-lg, and text-gray-900 for the white background section */}
        <div className="max-w-xl ml-auto mr-4 lg:mr-16 bg-white p-6 rounded-lg shadow-lg text-gray-900">
          {/* User Role Selection */}
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-lg text-lg font-bold uppercase transition-colors duration-200 mb-4
