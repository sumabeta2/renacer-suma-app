// ./components/PatientForm.tsx (Estilo Profesional)
...
  // Estilo base para Input/Textarea/Select (Outline Moderno)
  // Se usa un borde delgado que se enfoca con un color de acento (blue-500)
  const inputBaseStyle = "w-full p-3 border-2 rounded-lg text-gray-900 transition-colors duration-200 resize-y";
...
              rows={2} // Reducido a 2 filas para ser más compacto
