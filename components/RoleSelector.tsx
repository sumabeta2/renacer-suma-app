...
  // Asumo que UserRole.Medico, etc., son cadenas (strings)
  const roles = [UserRole.Medico, UserRole.Enfermero, UserRole.Paramedico, UserRole.PrimerRespondiente];
  
  // Mensaje de validación para el rol
  const isRoleSelected = selectedRole !== null;

  return (
    <div className="mb-4 pt-4 border-t border-gray-200">
      
      {/* Título de la Sección: Ajustado a tamaño 'base' y con ícono para compacidad y jerarquía */}
...
      <div className="flex flex-wrap gap-2"> {/* Usamos flex-wrap para ahorrar espacio */}
        {roles.map((role) => (
          <label
            key={role}
            // CLASES CLAVE PARA LA COMPACIDAD: py-2, px-4, rounded-full
...
                        ${selectedRole === role
                          ? 'border-red-600 bg-red-600 text-white shadow-md' // Color de acento Rojo SUMA
