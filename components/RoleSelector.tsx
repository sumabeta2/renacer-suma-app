// ./components/RoleSelector.tsx (Código final y actualizado)

import React from 'react';
import { UserRole } from '../types'; // <--- Importación actualizada
...
  // Usamos los roles definidos en types.ts
  const roles = [
    UserRole.Medico, 
    UserRole.Enfermero, 
    UserRole.Paramedico, 
    UserRole.PrimerRespondiente
  ];
  
